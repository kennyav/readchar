...
//   const { data, syncing, addBook, removeBook, completeSession, completeOnboarding } = useAppData();
//   //const [data, setData] = useState<AppData | null>(null);
//   const [showAddBook, setShowAddBook] = useState(false);
//   const [showTimer, setShowTimer] = useState(false);
//   const [selectedAttribute, setSelectedAttribute] = useState<AttributeType | null>(null);
//   const [showEvolution, setShowEvolution] = useState(false);
//   const { seed, books, hydrated } = useAvatarIdentity(data)
...
//   const handleAddBook = async (bookData: { title: string; author: string; genre: Genre; coverId: number }) => {
//     // const newBook: Book = {
...
//                 {data.books.map((book) => (
//                   <BookLogCard onDelete={removeBook} key={book.id} book={book} />
//                 ))}
//               </div>
//             ) : (
